...
namespace WindowsForms
{
    public partial class ExpertSystemsView : Form
    {
        ...
        private void lb_ExpertSystems_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                MainScreen.Instance!.OpenFormPanel(new EsEdit(new Builder((ExpertSystem)lb_ExpertSystems.SelectedItem)));
            }
        }
        ...
        {
            MainScreen.Instance!.OpenFormPanel(new EsEdit(new Builder()));
        }
